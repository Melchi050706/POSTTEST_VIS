Public Class FormUtama
    ...
    Sub TampilData()
        dgvKarakter.DataSource = GetKarakterDenganSenjata()
    End Sub
    ...
    Private Sub dgvKarakter_CellClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgvKarakter.CellClick
        ...
        If e.RowIndex >= 0 Then
            ...
            FormInput.txtNamaSenjata.Text = dgvKarakter.Rows(e.RowIndex).Cells(4).Value
            FormInput.txtTipeSenjata.Text = dgvKarakter.Rows(e.RowIndex).Cells(5).Value
            FormInput.txtDamage.Text = dgvKarakter.Rows(e.RowIndex).Cells(6).Value
